...
"""
function Cssp_fully_expanded_form(nussp::mk_float,ms::mk_float,msp::mk_float,
            d2fsdvpa2::mk_float,d2fsdvperp2::mk_float,d2fsdvperpdvpa::mk_float,
            dfsdvpa::mk_float,dfsdvperp::mk_float,fs::mk_float,
            d2Gspdvpa2::mk_float,d2Gspdvperp2::mk_float,d2Gspdvperpdvpa::mk_float,
            dGspdvperp::mk_float,dHspdvpa::mk_float,dHspdvperp::mk_float,
            fsp::mk_float,vperp_val::mk_float)
...
"""
function calculate_collisional_fluxes(F::mk_float,dFdvpa::mk_float,dFdvperp::mk_float,
                            d2Gdvpa2::mk_float,d2Gdvperpdvpa::mk_float,d2Gdvperp2::mk_float,
                            dHdvpa::mk_float,dHdvperp::mk_float,ms::mk_float,msp::mk_float)
...
function print_test_data(func_exact::AbstractArray{mk_float,2},
                    ...
                    vpa::finite_element_coordinate,
                    vperp::finite_element_coordinate,
                    dummy::AbstractArray{mk_float,2};print_to_screen=true::Bool)
    @. func_err = abs(func_num - func_exact)
    max_err = maximum(func_err)
    @. dummy = func_err^2
...
"""
function save_fkpl_error_data(outdir::String,ncore::mk_int,ngrid::mk_int,nelement_list::Vector{mk_int},
    max_C_err::Vector{mk_float}, max_H_err::Vector{mk_float}, max_G_err::Vector{mk_float}, max_dHdvpa_err::Vector{mk_float}, max_dHdvperp_err::Vector{mk_float},
    max_d2Gdvperp2_err::Vector{mk_float}, max_d2Gdvpa2_err::Vector{mk_float}, max_d2Gdvperpdvpa_err::Vector{mk_float}, max_dGdvperp_err::Vector{mk_float}, 
    L2_C_err::Vector{mk_float}, L2_H_err::Vector{mk_float}, L2_G_err::Vector{mk_float}, L2_dHdvpa_err::Vector{mk_float}, L2_dHdvperp_err::Vector{mk_float}, L2_d2Gdvperp2_err::Vector{mk_float},
    L2_d2Gdvpa2_err::Vector{mk_float}, L2_d2Gdvperpdvpa_err::Vector{mk_float}, L2_dGdvperp_err::Vector{mk_float},
    n_err::Vector{mk_float}, u_err::Vector{mk_float}, p_err::Vector{mk_float}, calculate_times::Vector{mk_float}, init_times::Vector{mk_float}, expected_t_2::Vector{mk_float}, expected_t_3::Vector{mk_float},
    expected_diff::Vector{mk_float}, expected_integral::Vector{mk_float})
...
Utility function that saves error data to a HDF5 file for later use.
"""
function save_fkpl_integration_error_data(outdir::String,ncore::mk_int,ngrid::mk_int,nelement_list::Vector{mk_int},
    max_dfsdvpa_err::Vector{mk_float}, max_dfsdvperp_err::Vector{mk_float}, max_d2fsdvperpdvpa_err::Vector{mk_float},
    max_H_err::Vector{mk_float}, max_G_err::Vector{mk_float}, max_dHdvpa_err::Vector{mk_float}, max_dHdvperp_err::Vector{mk_float},
    max_d2Gdvperp2_err::Vector{mk_float}, max_d2Gdvpa2_err::Vector{mk_float}, max_d2Gdvperpdvpa_err::Vector{mk_float}, max_dGdvperp_err::Vector{mk_float}, 
    expected_diff::Vector{mk_float}, expected_integral::Vector{mk_float})
